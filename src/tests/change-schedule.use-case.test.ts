...
describe.only("Change Schedule Use Case", () => {
  ...
  it('Não deve ser possível alterar o status de um agendamento concluído para cancelado', async () => {
    ...
    const result = await changeStatusSchedulingUseCase.execute(schedule.id, { status: 'concluído' })
  ...
  it('Não deve ser possível alterar o status de um agendamento cancelado', async () => {
    ...
    const result = await changeStatusSchedulingUseCase.execute(schedule.id, { status: 'cancelado' })
